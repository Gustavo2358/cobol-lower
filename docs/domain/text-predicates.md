...
Exact EQ/text predicates produce MODELED operation and coverage claims without a fabricated uncertainty. Figurative comparisons that still need collation retain ABSTRACTED/OPEN and the concrete reason. The synthetic exact-comparison regression checks AIR I-30 and round-trip validation alongside the original unknown-collation case.
