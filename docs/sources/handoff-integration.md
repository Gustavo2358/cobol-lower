...
| 19 | Critério primeiro sucesso | [documento](../domain/first-slice-entry-goback.md) | JSON real→AIR válida; sem output codec exigido neste slice. |
| 20 | Fora de escopo | [documento](../domain/first-slice-entry-goback.md) | Demais capacidades no backlog, não autorizadas. |
