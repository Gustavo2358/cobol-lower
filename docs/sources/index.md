...
| SRC-AIR-JAVA | Repositório com model/validator em air-model (artefato air-java) e codec compartilhado em air-json (runtime de adapters no 2A); implementação, não autoridade normativa |
