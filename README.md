...
**Primeiro slice em implementação — 6 de setembro de 2026.** O repositório partiu do harness documental v1. WORK-LOWER-001 está autorizado; CP0/CP1 certificaram build, boundary AIR, gates, golden SP e decoder, incluindo remoto green. CP2 adiciona validação semântica e admissão pela mesma porta em memória/arquivo. Não há implementação de lowering ainda.
