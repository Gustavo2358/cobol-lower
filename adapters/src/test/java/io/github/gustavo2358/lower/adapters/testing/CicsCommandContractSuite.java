...
public final class CicsCommandContractSuite {
    ...
    public static void main(String[] args)throws Exception {
        ...
        for(var version:List.of("2.46.0","9.99","future")){var j=base.deepCopy();j.put("contractVersion",version);command(j).put("commandKind","INVENTED");reject(j,SpJsonDecoder.Code.UNSUPPORTED_CONTRACT);}
