...
public final class FastAdapterSuite {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MoveDataIntegrationSuite.run(); PerformIntegrationSuite.run(); MultiCallIntegrationSuite.run(); EvaluateIntegrationSuite.run(); GoToIntegrationSuite.run(); PerformFamilyIntegrationSuite.run(); PerformUntilIntegrationSuite.run(); PartialIntegrationSuite.run();
