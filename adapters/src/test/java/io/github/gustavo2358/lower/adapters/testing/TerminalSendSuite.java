...
public final class TerminalSendSuite {
    ...
    public static void main(String[] args)throws Exception {
        ...
        for(var version:List.of("2.47.0","future","9.99")){var j=standalone.deepCopy();j.put("contractVersion",version);command(j).put("commandKind","BROKEN");reject(j,SpJsonDecoder.Code.UNSUPPORTED_CONTRACT);}
