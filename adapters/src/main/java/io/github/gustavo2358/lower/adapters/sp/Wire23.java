...
/** Exact SP 2.3.0 closed contract, including IF and storage evidence. No semantic parsing in core. */
final class Wire23 {
    private Wire23() { }
    ...
    record ProcedurePerformDocument(Wire.StatementHeaderDocument header, @Nullable PerformTargetDocument start, @Nullable PerformTargetDocument end,
        List<PerformParagraphDocument> procedures, ContinuationDocument normalContinuation, @Nullable PerformLoopDocument loop, List<String> gapCodes) implements StatementDocument { }
