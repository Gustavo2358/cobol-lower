...
/** Exact SP 2.4.0 closed contract, including IF and storage evidence. No semantic parsing in core. */
final class Wire24 {
    private Wire24() { }
    ...
    sealed interface StatementDocument permits GobackDocument, MoveDocument, CallDocument, IfDocument, ObservedDocument, PerformDocument, EvaluateDocument, GoToDocument, ProcedurePerformDocument {
    ...
    record ProcedurePerformDocument(Wire.StatementHeaderDocument header, @Nullable PerformTargetDocument start, @Nullable PerformTargetDocument end,
        List<PerformParagraphDocument> procedures, ContinuationDocument normalContinuation, @Nullable PerformLoopDocument loop,@Nullable PerformCountDocument times,List<String> gapCodes) implements StatementDocument { }
