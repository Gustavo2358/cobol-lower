...
/** Exact SP 2.1.0 closed contract, including IF and storage evidence. No semantic parsing in core. */
final class Wire21 {
    private Wire21() { }
    ...
    sealed interface StatementDocument permits GobackDocument, MoveDocument, CallDocument, IfDocument, ObservedDocument, PerformDocument, EvaluateDocument, GoToDocument {
