...
public final class SpJsonDecoder {
    ...
    private Result decodePayload(byte[] bytes, Meter meter) {
        ...
        try {
            ...
            if(!java.util.Set.of("2.14.0","2.15.0","2.16.0","2.17.0","2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue()))
            ...
            if(!java.util.Set.of("2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue())&&node.findValues("kind").stream().anyMatch(k->k.asText().equals("LOGICAL_FIT_TEXT")))return reject(Code.UNSUPPORTED_CONTRACT,"$/LOGICAL_FIT_TEXT requires SP 2.20");
            boolean logicalAccessContract=java.util.Set.of("2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue());
            ...
            if(!java.util.Set.of("2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue())&&!alternatives.isEmpty())
                return reject(Code.UNSUPPORTED_CONTRACT,"$/regionalAlternatives requires SP 2.18");
            if(java.util.Set.of("2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue())) {
            ...
            if(!java.util.Set.of("2.16.0","2.17.0","2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue())&&input.storage().isPresent())
            ...
            if (!java.util.Set.of("2.5.0","2.6.0","2.7.0","2.8.0","2.9.0","2.10.0","2.11.0","2.12.0","2.14.0","2.15.0","2.16.0","2.17.0","2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue())) for (var statement : input.statements()) {
            ...
            if(!java.util.Set.of("2.11.0","2.12.0","2.14.0","2.15.0","2.16.0","2.17.0","2.18.0","2.19.0","2.20.0","2.21.0","2.22.0","2.23.0").contains(node.path("contractVersion").textValue()))for(var statement:input.statements()) {
