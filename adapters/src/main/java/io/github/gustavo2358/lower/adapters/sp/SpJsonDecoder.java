...
public final class SpJsonDecoder {
    ...
    private Result decodePayload(byte[] bytes, Meter meter) {
        ...
        try {
            ...
            if(!node.path("contractVersion").textValue().equals("2.13.0"))
            ...
            if (!java.util.Set.of("2.5.0","2.6.0","2.7.0","2.8.0","2.9.0","2.10.0","2.11.0","2.12.0","2.13.0").contains(node.path("contractVersion").textValue())) for (var statement : input.statements()) {
            ...
            if(!java.util.Set.of("2.11.0","2.12.0","2.13.0").contains(node.path("contractVersion").textValue()))for(var statement:input.statements()) {
