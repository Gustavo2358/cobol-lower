...
/** SP2.22 static file sites; declarations remain independently available. */
final class Wire222 {
    ...
    enum Command { OPEN, READ, CLOSE }
    record Use(String statement,int ordinal,Command command,FileFacts.OpenMode mode,FileFacts.SyntaxProfile profile,
