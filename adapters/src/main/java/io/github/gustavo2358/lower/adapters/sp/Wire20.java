...
/** Exact SP 2.0.0 closed contract, including IF and storage evidence. No semantic parsing in core. */
final class Wire20 {
    private Wire20() { }
    ...
    sealed interface StatementDocument permits GobackDocument, MoveDocument, CallDocument, IfDocument, ObservedDocument, PerformDocument, EvaluateDocument {
