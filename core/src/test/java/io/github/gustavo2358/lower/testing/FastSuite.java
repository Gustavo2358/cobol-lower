...
public final class FastSuite {
    ...
    public static void main(String[] args) {
        int n = io.github.gustavo2358.lower.application.TopologyBindingSuite.run() + PositiveTopologySuite.run() + InputSuite.run() + LoweringSuite.run() + ScalarSuite.run() + CallSuite.run() + MoveDataSuite.run() + IfSuite.run();
