...
public final class BoundarySuite {
    ...
    public static void main(String[] args) {
        ...
        int semantic = count + io.github.gustavo2358.lower.application.LocalIdentitySuite.run() + InputSuite.run() + io.github.gustavo2358.lower.application.CompactIdentitySuite.run() + LoweringSuite.run();
        int performance = Boolean.getBoolean("lower.performance") ? PerformanceSuite.run() : 0;
