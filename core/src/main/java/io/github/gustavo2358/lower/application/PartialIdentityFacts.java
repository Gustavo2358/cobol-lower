...
final class PartialIdentityFacts {
    ...
    static void write(Object fact,Consumer<String> field,Consumer<Object> value) {
        switch(fact) {
            ...
            case FileFacts.Inventory r -> {field.accept("FileInventory");value.accept(r.availability());value.accept(r.declarations());value.accept(r.gapCodes());value.accept(r.operations());if(!r.declaratives().isEmpty()){field.accept("FileDeclaratives");value.accept(r.declaratives());}}
